...
/*   Updated: 2025/01/22 10:08:09 by ecorona-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double	vec_scalar_proj(t_vec u, t_vec v);
t_vec	vec_proj(t_vec u, t_vec v);
t_vec	vec_plane_proj(t_vec u, t_vec n);
t_vec	vec_rotate_ax(t_vec u, t_vec ax, double rad);
